...
kpar_surv=kpar(nu_ctr,channel_width,N_CHORDcosmo_int)
...
n_sph_pts_test=450 # this choice is not (yet) mathematically motivated ... it just seems like a sort of reasonable compromise between pedantry and the reality that, at the end of the day, this is an exercise in interpolation
