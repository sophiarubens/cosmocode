...
fidu_box=fidu.box
fidu_theta_max=fidu.theta_max
N_grid_pix=fidu.N_grid_pix
np.save("fidu_box.npy",fidu_box)
print("fidu theta_max=",fidu_theta_max)
t1=time.time()
print("built fiducially-beamed box in",t1-t0,"s")
pert.stack_to_box(delta_nu=deltanu)
pert_box=pert.box
pert_theta_max=pert.theta_max # should be the same as the other one bc of survey freq things... although there might be slight numerical differences if you start moving antennas or the region of support for one of the perturbed beams is very skewed
np.save("pert_box.npy", pert_box)
