...
print("CHORD-ish Airy beam alpha=",CHORD_ish_airy_alpha)
...
def W_binned_airy_beam(rk_vector,sig,r0,r_like_strategy,save=False,verbose=False,alpha=CHORD_ish_airy_alpha): # accumulate the kind of term we're interested in into a square grid
    npts=len(rk_vector)
    row=np.zeros(npts)
